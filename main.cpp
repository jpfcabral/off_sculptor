...
int main(){
    ...
    fin.open("/home/jpfcabral/UFRN/turmas/dca1202/off_sculptor/esculturas/teste.txt");
    if(!fin.is_open()){
        exit(0);
    }
...
//        cout << s << endl;
    ...
    t.writeOFF((char*)"/home/jpfcabral/UFRN/turmas/dca1202/off_sculptor/esculturas/teste.off");
    return 0;
}
